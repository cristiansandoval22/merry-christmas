...
gsap.from('.home__img-5', 1, { opacity: 0, y: 200, delay: 2, ease: "back.out" });
gsap.from('.home__img-8', 1, { opacity: 0, y: 200, delay: 2.5, ease: "back.out" });
...
gsap.from('.home__img-7', 1, { opacity: 0, y: 200, delay: 4.5, ease: "back.out" });
gsap.from('.home__img-4', 1, { opacity: 0, y: 200, delay: 5, ease: "back.out" });
gsap.from('.home__img-13', 1, { opacity: 0, y: 200, delay: 5.5, ease: "back.out(1.2)" });
gsap.from('.home__img-12', 1, { opacity: 0, y: 200, delay: 6, ease: "back.out(1.2)" }); 
gsap.from('.home__title', 1, { opacity: 0, y: 200, delay: 8, ease: "back.out(1.2)" });
